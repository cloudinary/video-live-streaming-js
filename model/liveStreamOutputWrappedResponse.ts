...
export class LiveStreamOutputWrappedResponse {
    'requestId': string;
    'data': LiveStreamOutputResponse;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "LiveStreamOutputResponse"
        }    ];

    static getAttributeTypeMap() {
        return LiveStreamOutputWrappedResponse.attributeTypeMap;
    }
}
