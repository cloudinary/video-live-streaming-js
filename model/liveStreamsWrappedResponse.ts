...
export class LiveStreamsWrappedResponse {
    'requestId': string;
    'data': Array<LiveStreamResponse> | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<LiveStreamResponse>"
        }    ];

    static getAttributeTypeMap() {
        return LiveStreamsWrappedResponse.attributeTypeMap;
    }
}
